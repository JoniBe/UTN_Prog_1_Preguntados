...
fondo_juego= pygame.transform.scale(fondo_juego, VENTANA_MEDIDA)
...
def abrir_juego(pantalla:pygame.Surface,cola_eventos:list[pygame.event.Event], juego)-> str:
    ...
    posicionar_botones(VENTANA_CENTRO_WIDTH,VENTANA_CENTRO_HEIGHT, botones[0]["rectangulo"])

    posicionar_botones(VENTANA_CENTRO_WIDTH,VENTANA_CENTRO_HEIGHT+70, botones[1]["rectangulo"])

    posicionar_botones(VENTANA_CENTRO_WIDTH,VENTANA_CENTRO_HEIGHT+140, botones[2]["rectangulo"])

    posicionar_botones(VENTANA_CENTRO_WIDTH,VENTANA_CENTRO_HEIGHT+210, botones[3]["rectangulo"])

    posicionar_botones(VENTANA_CENTRO_WIDTH,VENTANA_CENTRO_HEIGHT-200, boton_pregunta[0]["rectangulo"])
